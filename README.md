...
A random forest classifier could be used instead since the targeted accuracy score couln't be achieved with the neural networks here. Random forest model would perform faster than the neural networks and could have avoided the data from being overfitted.
